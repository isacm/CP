...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{render}\;\Varid{html}\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{writeFile}\;\text{\tt \char34 \char95 .html\char34}\;\Varid{html};\Varid{system}\;\text{\tt \char34 sensible-browser~\char95 .html\char34}\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[6]{}\hsindent{3}{}\<[9]%
\>[9]{}\Varid{exer}\mathrel{=}\mcond{(((\equiv )\;\mathrm{2})\comp \Varid{length})}{\Varid{execExer}}{\Varid{errInvArgs}}{}\<[E]%
\\
\>[6]{}\hsindent{3}{}\<[9]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{t2}\mathrel{=}\Varid{abpe}\;(\mathrm{1},\mathrm{33}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{execExerPar}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to \Conid{IO}\;(){}\<[E]%
\\
\>[B]{}\Varid{execExerPar}{}\<[14]%
\>[14]{}\mathrel{=}\underline{(\Varid{putStrLn}\comp \Varid{show}\comp \Varid{runEval}\comp (\Varid{parBTreeMap}\;\Varid{fib})\mathbin{\$}\Varid{t2})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{execExerSeq}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to \Conid{IO}\;(){}\<[E]%
\\
\>[B]{}\Varid{execExerSeq}\mathrel{=}\underline{(\Varid{putStrLn}\comp \Varid{show}\comp (\Varid{fmap}\;\Varid{fib})\mathbin{\$}\Varid{t2})}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{qsplit}\;(\Varid{n},\Varid{m})\mid (\Varid{m}\mathbin{<}\Varid{n})\mathrel{\vee}(\Varid{n}\equiv \mathrm{0}\mathrel{\wedge}\Varid{m}\equiv \mathrm{0})\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mid \Varid{n}\mathbin{<}\Varid{m}\mathrel{=}\mathbf{let}\;\Varid{p}\mathrel{=}\Varid{n}\mathbin{+}(\Varid{m}\mathbin{-}\Varid{n})\mathbin{+}\mathrm{1}\div \mathrm{2}\;\mathbf{in}\;i_2\;((\Varid{p},((\Varid{n},\Varid{p}\mathbin{-}\mathrm{1}),(\Varid{p}\mathbin{+}\mathrm{1},\Varid{m})))){}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mid \Varid{otherwise}\mathrel{=}i_2\;((\Varid{n},((\Varid{n},\Varid{m}\mathbin{-}\mathrm{1}),(\Varid{n}\mathbin{+}\mathrm{1},\Varid{m})))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{cataSList}\;\Varid{g}{}\<[15]%
\>[15]{}\mathrel{=}\Varid{g}\comp \Varid{recSList}\;(\Varid{cataSList}\;\Varid{g})\comp \Varid{outSList}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{mgen}\;([\mskip1.5mu \mskip1.5mu],\Varid{l})\mathrel{=}i_1\;\Varid{l}{}\<[E]%
\\
\>[B]{}\Varid{mgen}\;((\Varid{x}\mathbin{:}\Varid{xs}),(\Varid{y}\mathbin{:}\Varid{ys}))\mid \Varid{x}\leq \Varid{y}\mathrel{=}i_2\;(\Varid{x},(\Varid{xs},(\Varid{y}\mathbin{:}\Varid{ys}))){}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\mid \Varid{otherwise}\mathrel{=}i_2\;(\Varid{y},((\Varid{x}\mathbin{:}\Varid{xs}),\Varid{ys})){}\<[E]%
\\
\>[B]{}\mbox{\commentbegin -
...
\\[\blanklineskip]%
\>[B]{}\Varid{anaTLTree}\;{}\<[12]%
\>[12]{}\Varid{g}{}\<[16]%
\>[16]{}\mathrel{=}\Varid{inTLTree}\comp \Varid{recTLTree}\;(\Varid{anaTLTree}\;\Varid{g})\comp \Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataTLTree}\;\Varid{g}{}\<[16]%
\>[16]{}\mathrel{=}\Varid{g}\comp \Varid{recTLTree}\;(\Varid{cataTLTree}\;\Varid{g})\comp \Varid{outTLTree}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloTLTree}\;\Varid{h}\;\Varid{g}\mathrel{=}\Varid{cataTLTree}\;\Varid{h}\comp \Varid{anaTLTree}\;\Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tipsTLTree}\mathrel{=}\Varid{cataTLTree}\;\alt{\Varid{singl}}{\mathsf{conc}\comp (\Varid{id}\times\mathsf{conc})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{invTLTree}\mathrel{=}\Varid{cataTLTree}\;\alt{\Conid{L}}{{}\<[35]%
\>[35]{}\Conid{N}\comp \Varid{assocr}\comp \Varid{swap}\comp (\Varid{id}\times\Varid{swap})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{depthTLTree}\mathrel{=}\Varid{fromIntegral}\comp (\Varid{cataTLTree}\;\alt{\Varid{one}}{\Varid{succ}\comp \uncurry{(\Varid{max})}\comp (\Varid{id}\times\uncurry{(\Varid{max})})}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{transFirst}\mathrel{=}(\Varid{id}\times(\mathbin{\Varid{`div`}}\mathrm{2}))\times(\mathbin{-}\mathrm{1}\mathbin{+}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{transSnd}\;(((\Varid{x},\Varid{y}),\Varid{c}),\Varid{n})\mathrel{=}(((\Varid{x}\mathbin{+}\Varid{c}\div \mathrm{2},\Varid{y}),\Varid{c}\div \mathrm{2}),\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{transTh}\;(((\Varid{x},\Varid{y}),\Varid{c}),\Varid{n})\mathrel{=}(((\Varid{x},\Varid{y}\mathbin{+}\Varid{c}\div \mathrm{2}),\Varid{c}\div \mathrm{2}),\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{geneSierp}\mathbin{::}(\Conid{Tri},\Conid{Int})\to \Conid{Either}\;\Conid{Tri}\;((\Conid{Tri},\Conid{Int}),((\Conid{Tri},\Conid{Int}),(\Conid{Tri},\Conid{Int}))){}\<[E]%
\\
\>[B]{}\Varid{geneSierp}\;(\Varid{t},\Varid{n})\mid \Varid{n}\equiv \mathrm{0}\mathrel{=}i_1\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{27}{}\<[27]%
\>[27]{}\mid \Varid{otherwise}\mathrel{=}i_2\;(\Varid{transFirst}\;(\Varid{t},\Varid{n}),(\Varid{transSnd}\;(\Varid{t},\Varid{n}),\Varid{transTh}\;(\Varid{t},\Varid{n}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{geraSierp}\mathrel{=}\Varid{curry}\;(\Varid{anaTLTree}\;\Varid{geneSierp}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mathbf{instance}\;\Conid{Functor}\;\mathsf{TLTree}{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}\mathbf{where}\;\Varid{fmap}\;\Varid{f}\mathrel{=}\Varid{cataTLTree}\;(\Varid{inTLTree}\comp \Varid{baseTLTree}\;\Varid{f}\;\Varid{id}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{rep}\mathrel{=}\Varid{finalize}\comp \Varid{concat}\comp \Varid{tipsTLTree}\comp (\Varid{fmap}\;\Varid{drawTriangle})\comp \uncurry{(\Varid{geraSierp})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{type}\;\Conid{Pir}\mathrel{=}(\Conid{Point3D},\Conid{Side}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{type}\;\Conid{Point3D}\mathrel{=}(\Conid{Int},\Conid{Int},\Conid{Int}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{data}\;\Conid{PLTree}\;\Varid{a}\mathrel{=}\Conid{Pi}\;\Varid{a}\mid \Conid{No}\;(\Conid{PLTree}\;\Varid{a},(\Conid{PLTree}\;\Varid{a},(\Conid{PLTree}\;\Varid{a},(\Conid{PLTree}\;\Varid{a},\Conid{PLTree}\;\Varid{a}))))\;\mathbf{deriving}\;(\Conid{Eq},\Conid{Show}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inPLTree}\mathrel{=}\alt{\Conid{Pi}}{\Conid{No}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outPLTree}\;(\Conid{Pi}\;\Varid{a})\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outPLTree}\;(\Conid{No}\;(\Varid{t1},(\Varid{t2},(\Varid{t3},(\Varid{t4},\Varid{t5})))))\mathrel{=}i_2\;(\Varid{t1},(\Varid{t2},(\Varid{t3},(\Varid{t4},\Varid{t5})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{basePLTree}\;\Varid{g}\;\Varid{f}\mathrel{=}\Varid{g}+(\Varid{f}\times(\Varid{f}\times(\Varid{f}\times(\Varid{f}\times\Varid{f})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recPLTree}\;\Varid{f}\mathrel{=}\Varid{id}+(\Varid{f}\times(\Varid{f}\times(\Varid{f}\times(\Varid{f}\times\Varid{f})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anaPLTree}\;{}\<[12]%
\>[12]{}\Varid{g}{}\<[16]%
\>[16]{}\mathrel{=}\Varid{inPLTree}\comp \Varid{recPLTree}\;(\Varid{anaPLTree}\;\Varid{g})\comp \Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataPLTree}\;\Varid{g}{}\<[16]%
\>[16]{}\mathrel{=}\Varid{g}\comp \Varid{recPLTree}\;(\Varid{cataPLTree}\;\Varid{g})\comp \Varid{outPLTree}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloPLTree}\;\Varid{h}\;\Varid{g}\mathrel{=}\Varid{cataPLTree}\;\Varid{h}\comp \Varid{anaPLTree}\;\Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{instance}\;\Conid{Functor}\;\Conid{PLTree}{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}\mathbf{where}\;\Varid{fmap}\;\Varid{f}\mathrel{=}\Varid{cataPLTree}\;(\Varid{inPLTree}\comp \Varid{basePLTree}\;\Varid{f}\;\Varid{id}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tPir1}\;((\Varid{p},\Varid{c}),\Varid{n})\mathrel{=}\mathbf{let}\;\Varid{comp}\mathrel{=}(\Varid{c}\mathbin{\Varid{`div`}}\mathrm{2})\;\mathbf{in}\;((\Varid{p},\Varid{comp}),\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tPir2}\;(((\Varid{x},\Varid{y},\Varid{z}),\Varid{c}),\Varid{n})\mathrel{=}\mathbf{let}\;\Varid{comp}\mathrel{=}(\Varid{c}\mathbin{\Varid{`div`}}\mathrm{2})\;\mathbf{in}\;(((\Varid{x}\mathbin{+}\Varid{comp},\Varid{y},\Varid{z}),\Varid{comp}),\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tPir3}\;(((\Varid{x},\Varid{y},\Varid{z}),\Varid{c}),\Varid{n})\mathrel{=}\mathbf{let}\;\Varid{comp}\mathrel{=}(\Varid{c}\mathbin{\Varid{`div`}}\mathrm{2})\;\mathbf{in}\;(((\Varid{x},\Varid{y}\mathbin{+}\Varid{comp},\Varid{z}),\Varid{comp}),\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tPir4}\;(((\Varid{x},\Varid{y},\Varid{z}),\Varid{c}),\Varid{n})\mathrel{=}\mathbf{let}\;\Varid{comp}\mathrel{=}(\Varid{c}\mathbin{\Varid{`div`}}\mathrm{2})\;\mathbf{in}\;(((\Varid{x},\Varid{y}\mathbin{+}\Varid{comp},\Varid{z}\mathbin{+}\Varid{comp}),\Varid{comp}),\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tPir5}\;(((\Varid{x},\Varid{y},\Varid{z}),\Varid{c}),\Varid{n})\mathrel{=}\mathbf{let}\;\Varid{comp}\mathrel{=}(\Varid{c}\mathbin{\Varid{`div`}}\mathrm{2})\;\mathbf{in}\;(((\Varid{x}\mathbin{+}\Varid{comp},\Varid{y}\mathbin{+}\Varid{comp},\Varid{z}),\Varid{comp}),\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{genePiramide}\;(\Varid{p},\Varid{n})\mid \Varid{n}\equiv \mathrm{0}\mathrel{=}i_1\;\Varid{p}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mid \Varid{otherwise}\mathrel{=}i_2\;(\Varid{tPir1}\;(\Varid{p},\Varid{n}),(\Varid{tPir2}\;(\Varid{p},\Varid{n}),(\Varid{tPir3}\;(\Varid{p},\Varid{n}),(\Varid{tPir4}\;(\Varid{p},\Varid{n}),\Varid{tPir5}\;(\Varid{p},\Varid{n}))))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{geraPiramide}\mathrel{=}\Varid{curry}\;(\Varid{anaPLTree}\;\Varid{genePiramide}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{apresentaPiramide}\mathrel{=}\Varid{cataPLTree}\;\alt{\Varid{singl}}{\mathsf{conc}\comp (\Varid{id}\times\mathsf{conc})\comp (\Varid{id}\times(\Varid{id}\times\mathsf{conc}))\comp (\Varid{id}\times(\Varid{id}\times(\Varid{id}\times\mathsf{conc})))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{psierp}\;\Varid{t}\mathrel{=}\Varid{apresentaPiramide}\comp (\Varid{geraPiramide}\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{drawPyramid}\mathbin{::}\Conid{Pir}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{drawPyramid}\;((\Varid{x},\Varid{y},\Varid{z}),\Varid{side})\mathrel{=}{}\<[31]%
\>[31]{}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{draw'}\mathrel{=}\Varid{render}\;\Varid{html'}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{html'}\mathrel{=}\Varid{rep'}\;\Varid{dados'}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dados'}\mathrel{=}(((\mathrm{0},\mathrm{0},\mathrm{0}),\mathrm{10}),\mathrm{2}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rep'}\mathrel{=}\Varid{finalize}\comp \Varid{concat}\comp \Varid{apresentaPiramide}\comp (\Varid{fmap}\;\Varid{drawPyramid})\comp \uncurry{(\Varid{geraPiramide})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\pdfout{%
\begin{hscode}\SaveRestoreHook
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{gene}\;(i_2\;(\Varid{x},\Varid{y}))\mathrel{=}{}\<[22]%
\>[22]{}\Conid{D}\;[\mskip1.5mu ((\Varid{x}\mathbin{:}\Varid{y}),\mathrm{0.95}),(\Varid{y},\mathrm{0.05})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gene}\;(i_1\;()){}\<[20]%
\>[20]{}\mathrel{=}\Conid{D}\;[\mskip1.5mu ([\mskip1.5mu \text{\tt \char34 stop\char34}\mskip1.5mu],\mathrm{0.90}),([\mskip1.5mu \mskip1.5mu],\mathrm{0.1})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{parBTreeMap}\;\Varid{f}\;(\Conid{Node}\;(\Varid{r},(\Varid{d},\Varid{e})))\mathrel{=}\mathbf{do}\;\{\mskip1.5mu {}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{root}\leftarrow \Varid{rpar}\;(\Varid{f}\;\Varid{r});{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{esq}\leftarrow \Varid{parBTreeMap}\;\Varid{f}\;\Varid{d};{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{dir}\leftarrow \Varid{parBTreeMap}\;\Varid{f}\;\Varid{e};{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{return}\;(\Conid{Node}\;(\Varid{root},(\Varid{esq},\Varid{dir}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mskip1.5mu\}{}\<[3E]%
\ColumnHook
